                        ...
                        <div className="flex flex-co  items-center h-full">
                            <div className="flex flex-col gap-y-8 w-full">
                                <div className="flex flex-col">
                                    <h1 className="mb-4 text-3xl  font-bold">Welcome Back Bro ! </h1>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    <div className="w-[25rem] text-center">
                                        <button className="px-4 py-2 rounded-xl bg-gray-300 shadow-md text-gray-600 hover:bg-gray-400 hover:text-gray-100 duration-300 ease-out" onClick={()=>navigate('/admin/login')}>Admin Login</button>
                                    </div>
                                    <div className="w-[25rem] text-center">
