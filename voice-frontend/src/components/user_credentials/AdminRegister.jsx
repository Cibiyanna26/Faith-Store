...
const AdminRegister = () => {
    ...
    const Register = async (e) =>{
        ...
        try{
            setLoading(1)
            const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/users/admin/register`,
            {
                username,
                email,
                password
                        ...
                        <div className="flex  items-center h-full">
                            <div className="flex flex-col gap-y-8 w-full">
                                <div className="flex flex-col">
                                    <h1 className="mb-4 text-3xl  font-bold">New Admin Account ! </h1>
                                    <label className="text-gray-500">Become one of Higher Ups and explore </label>
                                </div>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    <div className="w-[25rem] text-center">
                                        <button className="px-4 py-2 rounded-xl bg-gray-300 shadow-md text-gray-600 hover:bg-gray-400 hover:text-gray-100 duration-300 ease-out" onClick={()=>navigate('/register')}>Student Signup</button>
                                    </div>
                                    <div className="w-[25rem] text-center">
